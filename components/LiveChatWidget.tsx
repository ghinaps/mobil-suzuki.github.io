...
const LiveChatWidget: React.FC = () => {
  const whatsappUrl = `https://api.whatsapp.com/send?phone=${SALES_INFO.phone}&text=${encodeURIComponent(
    `Halo ${SALES_INFO.name}, saya ingin bertanya tentang mobil Suzuki.`,
  )}`;
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 bg-green-500 text-white p-4 rounded-full shadow-md hover:shadow-xl hover:bg-green-600 transition-all duration-300 flex items-center justify-center active:scale-95"
    >
      <svg
