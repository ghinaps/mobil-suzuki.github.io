  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md relative">
        ...
        <h2 className="text-2xl font-bold text-suzukiBlue mb-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-suzukiBlue focus:border-suzukiBlue"
            />
          </div>
          <div>
            <label
            ...
            <select
              ...
              onChange={handleChange}
              required
              className="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-suzukiBlue focus:border-suzukiBlue"
            >
              {CARS.map((car) => (
          ...
          <button
            type="submit"
            className="w-full bg-suzukiRed text-white font-bold py-3 px-4 rounded-md hover:bg-red-700 transition-colors duration-300 mt-2"
          >
            Kirim via WhatsApp
          </button>
        </form>
